...
AppAsset::addCss($this,'/plugins/jquery-circliful/css/jquery.circliful.css');
AppAsset::addScript($this,'/plugins/waypoints/lib/jquery.waypoints.js');
AppAsset::addScript($this,'/plugins/counterup/jquery.counterup.min.js');
AppAsset::addScript($this,'/plugins/jquery-circliful/js/jquery.circliful.min.js');
AppAsset::addScript($this,'/plugins/jquery-sparkline/jquery.sparkline.min.js');
AppAsset::addScript($this,'/plugins/skyicons/skycons.min.js');
AppAsset::addScript($this,'/pages/jquery.dashboard.js');
...
<div class="row">
    <div class="col-sm-6 col-lg-3">
        <div class="widget-simple-chart text-right card-box">
            <div id="chart1" class="circliful-chart" data-dimension="90" data-text="35%" data-width="5" data-fontsize="14" data-percent="35" data-fgcolor="#5fbeaa" data-bgcolor="#ebeff2"></div>
            ...
            <p class="text-muted text-nowrap">今天总销售</p>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="widget-simple-chart text-right card-box">
            <div id="chart2" class="circliful-chart" data-dimension="90" data-text="75%" data-width="5" data-fontsize="14" data-percent="75" data-fgcolor="#3bafda" data-bgcolor="#ebeff2"></div>
            ...
            <p class="text-muted text-nowrap">每天游客</p>
        </div>
    </div>

    <div class="col-sm-6 col-lg-3">
        <div class="widget-simple-chart text-right card-box">
            <div id="chart3" class="circliful-chart" data-dimension="90" data-text="58%" data-width="5" data-fontsize="14" data-percent="58" data-fgcolor="#f76397" data-bgcolor="#ebeff2"></div>
            <h3 class="text-pink">$
                <span class="">
                      <script language=javascript>
                    var number = Math.random();
            ...
            <p class="text-muted text-nowrap">总收入</p>
        </div>
    </div>

    <div class="col-sm-6 col-lg-3">
        <div class="widget-simple-chart text-right card-box">
            <div id="chart4" class="circliful-chart" data-dimension="90" data-text="49%" data-width="5" data-fontsize="14" data-percent="49" data-fgcolor="#98a6ad" data-bgcolor="#ebeff2"></div>
            ...
            <p class="text-muted text-nowrap">未决订单</p>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="card-box">
            <h4 class="text-dark  header-title m-t-0 m-b-30">年度销售报告</h4>
    ...
    <div class="col-lg-4">
        <div class="card-box">
            <h4 class="text-dark header-title m-t-0 m-b-30">每周销售报告</h4>
...
jQuery(document).ready(function($) {
        $('.counter').counterUp({
            ...
            $('.circliful-chart>span').remove();
           $('.circliful-chart>canvas').remove();
          
          var randNum1 = parseInt(100*Math.random());
        var chart1 = $('#chart1');
        chart1.attr('data-percent',randNum1);
        chart1.attr('data-text', randNum1+'%');
        
        var randNum2 = parseInt(100*Math.random());
        var chart2 = $('#chart2');
        chart2.attr('data-percent',randNum2);
        chart2.attr('data-text', randNum2+'%');
        
        var randNum3 = parseInt(100*Math.random());
        var chart3 = $('#chart3');
        chart3.attr('data-percent',randNum3);
        chart3.attr('data-text', randNum3+'%');
        
        var randNum4 = parseInt(100*Math.random());
        var chart4 = $('#chart4');
        chart4.attr('data-percent',randNum4);
        chart4.attr('data-text', randNum4+'%');
